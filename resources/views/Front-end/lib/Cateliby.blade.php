        ...
        <div class="col-md-7">
            @foreach ($result as $item)
                <div class="row p-0 mb-3">
                    <div class="col-md-2">
                      <img src="https://api-nasla.interior.gov.kh/v1/api/library/{{ $item['id'] }}?isPdf=false" alt="" class="img-fluid">
                    </div>
                    <div class="col-md-7">
                    ...
                    <div class="col-3"> 
                        ...
                        <a  href="{{ $item['url'] }}" class="btn btn-success Siemreap" download><i class="fa-solid fa-download mr-2"></i>ទាញយកឯកសារ</a>
...
<div class="container rps-sort-lib">
    ...
    <div class="col-12 mt-2">
      @foreach ($result as $item)
        <div class="card">
          <img src="https://api-nasla.interior.gov.kh/v1/api/library/{{ $item['id'] }}?isPdf=false" class="card-img-top img-fluid" alt="Fissure in Sandstone"/>
          <div class="card-body">
            ...
            <a href="https://api-nasla.interior.gov.kh/v1/api/library/{{ $item['id'] }}" class="btn btn-success Siemreap" download><i class="fa-solid fa-download mr-2"></i>{{ __('messages.Download') }}</a>
          </div>
        </div>
      @endforeach
    </div>
