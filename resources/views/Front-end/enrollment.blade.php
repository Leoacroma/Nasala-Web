    ...
    <div class="container">
        <div class="row">         
            ...
            @endphp
                <div class="col-md-5">
                    <div class="card" >
                    <img src="https://api-nasla.interior.gov.kh/v1/api/files/{{ $item['thumbnailImageId'] }}" class="card-img-top img-fluid" style="aspect-ratio: 3/2; object-fit: contain" alt="Fissure in Sandstone"/>
