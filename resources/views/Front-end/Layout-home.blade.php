                ...
                <ul class="navbar-nav m-auto ">
                    ...
                    <li class="nav-item dropdown {{ Route::currentRouteNamed('front.work.dp1') ? 'actived' : '' }}">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item " href="{{ route('front.work.dp1') }}">ផែនការបណ្តុះបណ្តាល</a></li>
                            <li class="dropend mg-l-m10 pd-r-8">
                                <a class="dropdown-item dropdown-toggle Siemreap" href="#">ឯកសារបណ្តុះបណ្តាល</a>
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="{{ route('front.work.dp2Content') }}">វគ្គគ្រប់គ្រងជាន់ខ្ពស់</a></li>
                            ...
                            <li><a class="dropdown-item" href="{{ route('front.work.dp3') }}">ចុះឈ្មោះចូលរៀន</a></li>
                        </ul>
                    </li>
        ...
        <div class="container-field bg-color-355fb6">
            <div class="container">
                <div class="row mt-3 p-2">
                    ...
                    <div class="col-lay-3 ">
                        <img src="/img/police-test1.jpg " alt=" " width="400px " height="150px" style="margin-bottom: 30px;">
                    </div>
                </div>
            </div>
