                                           ...
                                           <div class="row">
                                            <div class="row row-cols-1 row-cols-md-3 g-4">
                                                @foreach ($result as $dd)
                                                    <div class="col">
                                                        <div class="card" >
                                                            <img src="https://api-nasla.interior.gov.kh/v1/api/files/{{ $dd['thumbnailImageId'] }}"  class="card-img-top" alt="Hollywood Sign on The Hill"/>
                                                            <div class="card-body">
                                        ...
                                        @foreach ($cate['data'] as $item)
                                            <div class="tab-pane fade" id="cate-tab-{{ $item['id'] }}" role="tabpanel" aria-labelledby="cate-tab-{{ $item['id'] }}">
                                                <div class="row row-cols-1 row-cols-md-3 g-4">
                                                    ...
                                                    <div class="col">
                                                        <div class="card" >
                                                            <img src="https://api-nasla.interior.gov.kh/v1/api/files/{{ $dd['thumbnailImageId'] }}" style="height: 200px;" class="card-img-top" alt="Hollywood Sign on The Hill"/>
                                                        <div class="card-body">
                                                            <span class="card-title kantumruy" style="font-size: 16px; line-height: 25.5px;">{{ \Illuminate\Support\Str::limit($dd['titleKh'], $limit = 90, $end = '...')}}</span>
                                                            <br/>
                                                            <small class="text-muted kantumruy">{{ $dd['createdAt'] }}</small>
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="card-group">
                                            <div class="row g-0">
                                                <div class="col-md-4">
                                                  <img
                                                    src="https://api-nasla.interior.gov.kh/v1/api/files/{{ $tt['thumbnailImageId'] }}"
                        ...
                        <div class="product-order-wrap padding-reduced">
                            ...
                            @endphp
                                <div class="col-3">
                                      ...
                                      <div class="card" >
                                        <img src="https://api-nasla.interior.gov.kh/v1/api/files/{{ $item['thumbnailImageId'] }}" class="card-img-top img-cdd" alt="Fissure in Sandstone"/>
